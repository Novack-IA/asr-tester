...
LOG_FILE = "transcription_log_deepgramteste3.txt"
SAMPLE_SIZE = 100
...
def log_transcription(file_name, reference_text, transcribed_text, metrics, audio_duration, processing_time, modelo):
    with open(LOG_FILE, "a", encoding="utf-8") as log:
        ...
        log.write(f"Modelo Deepgram: {modelo}\n")
        log.write("-" * 50 + "\n")
...
def process_dataset():
    ...
    for file_path in sampled_files:
        ...
        try:
            ...
            log_transcription(file_name, reference_text, transcription, metrics, audio_duration, duration, modelo)
...
if __name__ == "__main__":
    ...
    df_results.to_csv("results_deepgramteste3.csv", index=False, encoding="utf-8")
